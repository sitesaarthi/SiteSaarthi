...
class ClientCcPage extends StatefulWidget {
  const ClientCcPage({super.key});

  @override
  State<ClientCcPage> createState() => _ClientCcPageState();
}

class _ClientCcPageState extends State<ClientCcPage> {
  ...
  Future<void> fetchUrl(String projectId) async {
    try {
      ...
      final res = await http.get(
        Uri.parse("$baseUrl/docs/$projectId/manual-url?key=cc"),
