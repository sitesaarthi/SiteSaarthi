...
class ClientIodPage extends StatefulWidget {
  const ClientIodPage({super.key});

  @override
  State<ClientIodPage> createState() => _ClientIodPageState();
}

class _ClientIodPageState extends State<ClientIodPage> {
  ...
  Future<void> fetchUrl(String projectId) async {
    try {
      ...
      final res = await http.get(
        Uri.parse("$baseUrl/docs/$projectId/manual-url?key=iod"),
