...
class ClientReraPage extends StatefulWidget {
  const ClientReraPage({super.key});

  @override
  State<ClientReraPage> createState() => _ClientReraPageState();
}

class _ClientReraPageState extends State<ClientReraPage> {
  ...
  Future<void> fetchUrl(String projectId) async {
    try {
      ...
      final res = await http.get(
        Uri.parse("$baseUrl/docs/$projectId/manual-url?key=rera"),
