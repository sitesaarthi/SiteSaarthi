...
class ClientDocsPage extends StatefulWidget {
  const ClientDocsPage({super.key});

  @override
  State<ClientDocsPage> createState() => _ClientDocsPageState();
}

class _ClientDocsPageState extends State<ClientDocsPage> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              Text(
                "View all compliance & billing documents shared by owner",
                style: GoogleFonts.inter(
                  fontSize: 13,
                  fontWeight: FontWeight.w700,
                  color: const Color(0xFF64748B),
              ...
              GridView.count(
                ...
                children: [
                  PaperCard(
                    ...
                    desc: "View official RERA certificate PDF",
                    icon: Icons.verified_user_rounded,
                    bg: const Color(0xFFEFF6FF),
                    fg: const Color(0xFF2563EB),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsRera, projectId),
                  ),
                  PaperCard(
                    title: "IOD",
                    desc: "View IOD document PDF",
                    icon: Icons.assignment_rounded,
                    bg: const Color(0xFFFFFBEB),
                    fg: const Color(0xFFD97706),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsIod, projectId),
                  ),
                  PaperCard(
                    title: "Commencement Certificate (CC)",
                    desc: "View CC certificate PDF",
                    icon: Icons.approval_rounded,
                    bg: const Color(0xFFECFDF5),
                    fg: const Color(0xFF059669),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsCc, projectId),
                  ),
                  PaperCard(
                    title: "Proposal Report",
                    desc: "View proposal + report PDF",
                    icon: Icons.description_rounded,
                    bg: const Color(0xFFEEF2FF),
                    fg: const Color(0xFF4F46E5),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsProposal, projectId),
                  ),
                  PaperCard(
                    title: "Quotation",
                    desc: "View quotation PDF",
                    icon: Icons.request_quote_rounded,
                    bg: const Color(0xFFFFF1F2),
                    fg: const Color(0xFFDC2626),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsQuotation, projectId),
                  ),
                  PaperCard(
                    title: "GST Invoice",
                    desc: "View GST invoice PDF",
                    icon: Icons.receipt_long_rounded,
                    bg: const Color(0xFFEFF6FF),
                    fg: const Color(0xFF2563EB),
                    ctaText: "View →",
                    onTap: () =>
                        _openDocPage(AppRoutes.clientDocsGstInvoice, projectId),
                  ),
                ],
              ),
            ],
